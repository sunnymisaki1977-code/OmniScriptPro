export const AUDIENCE_THEMES = {
  ...
  food: {
    ...
    primaryBtn: 'bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-400 hover:to-amber-400 text-white shadow-orange-500/20',
    secondaryBtn: 'bg-orange-500/10 text-orange-300 border-orange-500/20 hover:bg-orange-500/20',
    textMuted: 'text-orange-400',
    accentText: 'text-amber-400',
    accentBg: 'bg-amber-500/10',
    ringColor: 'focus:ring-orange-500 focus:border-orange-500',
    pipelineCurrent: 'bg-orange-900/40 border-orange-500/50 shadow-[0_0_30px_rgba(249,115,22,0.25)]',
    pipelineCurrentIcon: 'bg-orange-500 text-white animate-pulse',
    tagBg: 'bg-orange-500/10 border-orange-500/20 text-orange-300',
  ...
  historyMeme: {
    ...
    bgActive: 'bg-amber-600/10',
    bgBadge: 'bg-amber-500/10 border-amber-500/20 text-amber-300',
    primaryBtn: 'bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-400 hover:to-orange-500 text-white shadow-amber-500/20',
    secondaryBtn: 'bg-amber-500/10 text-amber-300 border-amber-500/20 hover:bg-amber-500/20',
    textMuted: 'text-amber-400',
