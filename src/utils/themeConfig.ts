export const AUDIENCE_THEMES = {
  ...
  proposal: {
    ...
    pipelineCurrentIcon: 'bg-[#10B981] text-white animate-pulse',
    tagBg: 'bg-[#F8FAFC] border-slate-200 text-[#64748B]',
    matrixRequired: 'bg-emerald-900/50 text-[#10B981] border border-emerald-500/30 cursor-not-allowed opacity-80',
    matrixSelected: 'bg-emerald-500 text-white shadow-md hover:bg-emerald-600',
    matrixUnselected: 'bg-white border border-slate-200 text-[#64748B] hover:bg-emerald-50',
    ...
    themeLogMessage: '[Theme] 已切換至「極簡專業・商業提案 (Emerald Success)」模式。啟動專業清晰排版，提升提案說服力 🟢'
  },
  edtech: {
    id: 'edtech',
    ambientGlow: 'bg-blue-500',
    title: 'EdTech 知識賦能',
    subtitle: 'Digital Learning 知識領航',
    desc: '現代幾何圖解、立體微縮與手帳風格，專為知識萃取、線上教育與科技賦能設計。',
    gradient: 'from-[#3B82F6] to-[#1E3A8A]',
    primaryColor: 'blue-500',
    borderActive: 'border-[#3B82F6]/50',
    textActive: 'text-[#3B82F6]',
    bgActive: 'bg-[#3B82F6]/10',
    bgBadge: 'bg-[#F59E0B]/10 border-[#F59E0B]/20 text-[#F59E0B]',
    primaryBtn: 'bg-gradient-to-r from-[#3B82F6] to-[#1E3A8A] hover:opacity-90 text-white rounded-full shadow-lg hover:-translate-y-[2px] transition-all duration-300',
    secondaryBtn: 'bg-[#F8FAFC] text-[#1E293B] border-slate-200 hover:bg-slate-100 rounded-full',
    textMuted: 'text-[#64748B]',
    accentText: 'text-[#F59E0B]',
    accentBg: 'bg-[#F59E0B]/10',
    ringColor: 'focus:ring-[#3B82F6] focus:border-[#3B82F6]',
    pipelineCurrent: 'bg-white border-[#3B82F6]/50 shadow-[0_4px_20px_rgba(59,130,246,0.05)]',
    pipelineCurrentIcon: 'bg-[#3B82F6] text-white animate-pulse',
    tagBg: 'bg-[#F8FAFC] border-slate-200 text-[#64748B]',
    matrixRequired: 'bg-blue-900/50 text-[#3B82F6] border border-blue-500/30 cursor-not-allowed opacity-80',
    matrixSelected: 'bg-blue-500 text-white shadow-md hover:bg-blue-600',
    matrixUnselected: 'bg-white border border-slate-200 text-[#64748B] hover:bg-blue-50',
    focusRing: 'focus:border-blue-500/50',
    actionBtn: 'bg-blue-600 hover:bg-blue-500 text-white',
    actionBtnOutline: 'bg-blue-500/10 text-blue-600 hover:text-blue-700 border border-blue-500/20 hover:border-blue-500/50 hover:bg-blue-500/20',
