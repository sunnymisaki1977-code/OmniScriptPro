...
你是一位專精於臺灣民俗學、宗教學、人類學與歷史文化研究的學者，請務必優先使用 Google 搜尋查證最準確的文獻再回答。
...
- 視覺畫面建議：[請描述結尾畫面]
- 畫面字卡: [必須精煉為 10 個字以內的核心金句]
- 旁白配音 (VO)：[總結核心精神，並帶上宣言【解碼台灣神佛，看懂世代相傳的信仰，銘印於心的文化傳承】引導觀眾訂閱、按讚【開啟傳奇好運小鈴鐺】與留言分享經驗]`
  },
  {
    id: 3,
    title: "影音 SEO 標題優化",
...
【核心任務】
根據下方的《長影音腳本》，為主題「${ctx.theme}」產出能極大化點擊率（CTR）與搜尋排名的 SEO 內容。
...
... (請依據腳本邏輯抓取 3-5 個時間軸)`  },
  {
    ...
    type: "text",
    dependsOn: ["theme", "step1"],
    prompt: (ctx: any) => `請根據以下背景資料，為「${ctx.theme}」撰寫一份 180 秒內的 YouTube Shorts/TikTok 短影片腳本。
你是一位專精於 TikTok / YouTube Shorts 的千萬流量短影音爆款編劇。

【核心任務】
根據下方的《基礎背景資料》，為主題「${ctx.theme}」撰寫一份 180 秒內的短影片腳本。節奏必須明快。
...
- 視覺畫面：[請描述搭配畫面]
- 畫面字卡: [必須精煉為 10 個字以內的核心金句，最後引導留言或點擊主頁的畫面]
- 旁白配音 (VO)：[總結精要，最後拋出一個問題讓觀眾留言，並呼籲追蹤]`  },
  {
    id: 5,
    title: "擴散式 SEO 標籤優化",
...
請針對主題「${ctx.theme}」請務必優先使用 Google 搜尋查證最準確的1500字的專業美食知識報告。
...
請針對主題「${ctx.theme}」請務必優先使用 Google 搜尋查證最準確的1500字的完整分析。
...
【撰寫指令】：
請打破生硬的條列式與幕次框架，為主題「${ctx.theme}」撰寫一篇約 1500 字的沉浸式傳奇故事。
- 語氣必須是引人入勝、極具畫面感的「說書人」口吻。
...
### 📖 高能說書：核心傳奇
- [00:05 - 01:30] 畫面：[配合語音快速切換動態分鏡] / 字卡：[短小精悍的關鍵字] / 旁白 (VO)：[濃縮原著中最精彩的鬥法、收妖或得道瞬間。語速快，情緒高昂]

### 📢 信仰印記與互動 (CTA)
- [01:30 - 03:00] 畫面：[現代廟宇或信眾祈福畫面] / 字卡：[引導留言] / 旁白 (VO)：[點出祂現在保佑什麼，並提問「你有去拜過嗎？留言告訴我！」呼籲追蹤]`
  },
  {
    id: 5,
    title: "擴散式 SEO 標籤優化",
...
### 💖 溫馨結尾 (Outro/CTA)
 (時間規劃：07:00 - 08:00，共 2 個節點)
請依序產出 [07:00 - 07:30]、[07:30 - 08:00]：
- 視覺畫面建議：[描述大家開懷大笑、溫暖和諧的快樂結局畫面]
- 畫面字卡: [總結故事的正面精神，如「勇敢做自己」]
- 旁白配音 (VO)：[語氣溫柔地總結故事道理，並帶上宣言【跟著我們一起聽故事，發現世界的大奇妙】，引導家長與小朋友按讚、訂閱，並留言分享他們的想法]`
    },
    {
      id: 3,
      title: "影音 SEO 標題優化",
