...
除了整理具體視覺特徵，請務必「提供 3-5 組真實且有效的圖片網址（Image URL）」，作為後續 AI 圖像生成的墊圖參考（Image Prompt）。
...
你是一位專精於臺灣民俗學、宗教學、人類學與歷史文化研究的學者，請務必優先使用 Google 搜尋查證最準確的文獻再回答，🌟 視覺特徵與建築藝術（實地取景必備）
【⚠️ 強制圖像查證指令】：請透過 Google 搜尋『${ctx.theme}』的相關報導與資料，幫我整理出這座廟宇與鎮殿神尊的具體視覺特徵（包含建築外觀、神像風格、色彩與氛圍）。
請依據查證結果，詳細描述以下視覺細節，以利後續 AI 圖像生成參考：
- 建築外觀與格局：屋頂形式（如歇山重簷）、剪黏藝術、石雕木雕特色。
- 鎮殿神像風格：神尊材質（如紅豆杉、泥塑）、面容特徵、服飾色彩與歷史年代感。
- 空間氛圍與光線：廟宇內部的光影表現、香火鼎盛的視覺感或寧靜莊嚴的氛圍。
...
====================
🌟 視覺特徵與建築藝術（實地取景必備）
「提供 3-5 組真實且有效的圖片網址（Image URL）」，作為後續 AI 圖像生成的墊圖參考（Image Prompt）。
...
- 視覺畫面建議：[請描述結尾畫面]
- 畫面字卡: [必須精煉為 10 個字以內的核心金句]
- 旁白配音 (VO)：[總結核心精神，並帶上宣言【解碼台灣神佛，看懂世代相傳的信仰，銘印於心的文化傳承】引導觀眾訂閱、按讚與留言分享經驗]`
  },
  {
    id: 3,
    title: "影音 SEO 標題優化",
