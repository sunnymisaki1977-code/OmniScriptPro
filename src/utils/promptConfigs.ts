...
1. **【主題神祇查核】**：
   - 你查詢的「${ctx.theme}」名字是。
   - 答：
   - 你查詢的名字在台灣宮廟、地方誌或經典中，公認的【聖誕千秋日（農曆月份與日期）】。
   - 答：

2. **【UID 雙重反查】**：
   - 以你上一步回答的名字反查詢，查到的名字是。
   - 答：
   - 反查詢查到的名字在台灣宮廟、地方誌或經典中，公認的【聖誕千秋日（農曆月份與日期）】。   
   - 答：
所有結果結果全部符合？【 是 / 否 】
 - 判定結果：若不同，即代表祂們在神學系統中為【完全不同的兩尊神明】。你後面所有的 1500 字報告，必須嚴格區分兩者，絕對不准將混淆神祇的事蹟、法相、封號套用在主題神祇上！
