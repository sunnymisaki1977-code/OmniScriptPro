...
AI Prompt (中文):
  16:9 動態分割構圖提示詞：
以「${ctx.theme}」為核心主角，主標題：[主標題]，包含五個蒙太奇資訊：
1. 畫格 1：[資訊 1] - 視覺描述：[描述]
2. 畫格 2：[資訊 2] - 視覺描述：[描述]
3. 畫格 3：[資訊 3] - 視覺描述：[描述]
4. 畫格 4：[資訊 4] - 視覺描述：[描述]
...
### 🎨 視覺 Prompt
  16:9 動態分割構圖提示詞：  
以「${ctx.theme}」為核心，必須包含風格：colorful ink wash, vivid diffusion, golden particles, energy flow, eastern fantasy, gold flowing accents, rice paper texture, eastern mythology, spiritual energy, cinematic lighting, ultra detailed。運用【動態分割構圖（Dynamic Segmented Layout）】以及【美式漫畫跨頁插圖（Comic Book Splash Page with Insets）】組合併接成一張【蒙太奇資訊圖表（Montage Infographic）】。
  主標題：  [請填入主標題]
1.   畫格 1：   [蒙太奇資訊名稱 1]
   視覺描述：  [(強制帶入主角英文外觀) + 請填入視覺描述]
2.   畫格 2：   [蒙太奇資訊名稱 2]
   視覺描述：  [(強制帶入主角英文外觀) + 請填入視覺描述]
3.   畫格 3：   [蒙太奇資訊名稱 3]
   視覺描述：  [(強制帶入主角英文外觀) + 請填入視覺描述]
