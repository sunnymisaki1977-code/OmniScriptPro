...
（如果是神佛類別，進行雙重反查防呆程序）：
1. **【主題神祇查核】**：
   - 查詢主題「${ctx.theme}」在台灣宮廟、地方誌或經典中，公認的【聖誕千秋日（農曆月份與日期）】。
   - 答：[例如：農曆六月初六]

2. **【熱門/同姓混淆神祇查核】**：
   - 找出名字、姓氏或前綴容易與「${ctx.theme}」混淆的 1~2 位常見大眾神祇。
   - 查詢這些混淆神祇的【聖誕千秋日（農曆月份與日期）】。
   - 答：[例如：八仙李鐵拐的聖誕日為農曆七月初十]

3. **【UID 雙重反查結論】**：
   - 兩者的聖誕千秋日是否完全相同？【 是 / 否 】
   - 判定結果：若兩者聖誕日不同，即代表祂們在神學系統中為【完全不同的兩尊神明】。你後面所有的 1500 字報告，必須嚴格區分兩者，絕對不准將混淆神祇的事蹟、法相、封號套用在主題神祇上！

---
（確認上述反查無誤後，再開始撰寫以下的詳細結構化報告...）
