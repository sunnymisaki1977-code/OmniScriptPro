...
### 五、 法相特徵與隨身法器（祂長什麼樣子？）
* **金身法相解析：**
  * **面容與神情：** 膚色（如黑面媽祖代表威赫、粉面代表親和）、神情（慈祥、威嚴、憤怒降魔尊）。
  * **服飾與冠冕：** 身穿文袍、武冠、龍袍或一襲白衣？
  * **坐騎：** 是否有專屬坐騎？（如：文詢菩薩騎獅、普賢菩薩騎象、玄天上帝腳踏龜蛇）。
...
* **海內外代表性廟宇：**
  * 歷史悠久的發源祖廟（如：湄洲媽祖祖廟、解州關帝廟）。
  * 現今香火最鼎盛、最具指標性的代表宮廟。
* **獨特民俗與宗教儀式：** 與祂緊密相關的特殊民俗活動（如：遶境進香、割香、建醮祈安、王爺信仰的「燒王船」、特殊的民俗陣頭）。

### 八、 小說演義 / 民間傳說 對比
* 請詳細比對正史記載（如《三國志》）與 小說演義 / 民間傳說（如《三國演義》）的差異。讓整體介紹既具備學術公信力，又充滿引人入勝的文學趣味。
...
【⚠️ 絕對真實性指令】：
你在本腳本中提及的所有生平、神明數量、科儀名稱與神話，  必須 100% 遵守下方提供的背景資料，不可修改名詞定義  。
