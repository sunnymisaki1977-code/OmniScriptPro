...
export const WORKFLOWS_REGISTRY: Record<string, WorkflowStep[]> = {
  heritage: [
    ...
    prompt: (ctx: any) => `你是一位台灣民俗文化、宗教信仰、歷史研究與節氣文化專家你是一位民俗文化頻道的專屬策展人與內容生成專家，請務必優先使用 Google 搜尋查證最準確的文獻再回答，🌟 視覺特徵與建築藝術（實地取景必備）
...
【⚠️ 強制圖像查證指令】：請參照《基礎背景史料》
====================
${ctx.step1}
====================
整理出這座廟宇與鎮殿神尊的具體視覺特徵（包含建築外觀、神像風格、色彩與氛圍）。
請依據查證結果，後續 AI 圖像生成：
- 建築外觀與格局：屋頂形式（如歇山重簷）、剪黏藝術、石雕木雕特色。
- 鎮殿神像風格：神尊材質（如紅豆杉、泥塑）、面容特徵、服飾色彩與歷史年代感。
- 空間氛圍與光線：廟宇內部的光影表現、香火鼎盛的視覺感或寧靜莊嚴的氛圍。
