...
### ⏱️ [00:00 - 01:00] 引人入勝的開場 (Hook)
- 視覺畫面建議：[請描述開場畫面]
- 畫面字卡: [10字以內的震撼標題]
- 旁白配音 (VO)：[用強烈懸念或驚人事實開場，勾起觀眾好奇心]
(每個30秒產出畫面節點、畫面字卡、旁白配音 (VO))
### ⏱️ [01:00 - 04:00] 深度解析：起源與神話
- 視覺畫面建議：[請描述搭配畫面]
- 畫面字卡: [必須精煉為 10 個字以內的核心金句]
- 旁白配音 (VO)：[將背景資料轉化為流暢的故事敘述]
(每個30秒產出畫面節點、畫面字卡、旁白配音 (VO))
### ⏱️ [04:00 - 07:00] 核心信仰與現代影響
- 視覺畫面建議：[請描述搭配畫面]
- 畫面字卡: [必須精煉為 10 個字以內的核心金句]
- 旁白配音 (VO)：[解析其對現代社會、特定行業或信仰圈的影響]
(每個30秒產出畫面節點、畫面字卡、旁白配音 (VO))
### ⏱️ [07:00 - 08:00] 總結與互動引導 (Outro/CTA)
- 視覺畫面建議：[請描述結尾畫面]
- 畫面字卡: [必須精煉為 10 個字以內的核心金句]
- 旁白配音 (VO)：[總結核心精神，並引導觀眾訂閱、按讚與留言分享經驗]
(每個30秒產出畫面節點、畫面字卡、旁白配音 (VO))`
  },
  {
    id: 3,
