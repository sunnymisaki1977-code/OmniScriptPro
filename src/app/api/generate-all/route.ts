...
步驟 10：社群推播懶人包。請提供三部分內容，務必以「### 視覺 Prompt」、「### 圖卡排版字卡」、「### 社群發布正文」作為小標題：(1) ### 視覺 Prompt：包含 16:9 與 9:16 的動態分割構圖提示詞 (Comic Book Splash Page, Montage Infographic, colorful ink wash)；(2) ### 圖卡排版字卡：為 4~5 個高光時刻設計適合放在圖片上的短標題與一句話說明；(3) ### 社群發布正文：包含 Hook 開場白、3-5點亮點解析、互動提問、祈福導流與 Hashtags。
