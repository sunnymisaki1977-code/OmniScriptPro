...
如果判斷為【第一類：神佛/歷史人物】，請輸出以下 JSON 格式：
{
  ...
  "tags": ["標籤1", "標籤2", "標籤3"],
  "imagePrompt": "請針對主題「${name}」生成 3 組 彩墨風格圖中文 Prompt。視覺設計必須包含風格標籤 (colorful ink wash, vivid diffusion, golden particles, energy flow, eastern fantasy, gold flowing accents, rice paper texture, eastern mythology, spiritual energy, cinematic lighting, ultra detailed)，充滿禪意或史詩感的氛圍。"
}
...
如果判斷為【第二類：民俗/節氣/宮廟】，請輸出以下 JSON 格式：
{
  ...
  "tags": ["標籤1", "標籤2", "標籤3"],
  "imagePrompt": "請針對主題「${name}」生成 3 組 彩墨風格圖中文 Prompt。視覺設計必須包含風格標籤 (colorful ink wash, vivid diffusion, golden particles, energy flow, eastern fantasy, gold flowing accents, rice paper texture, eastern mythology, spiritual energy, cinematic lighting, ultra detailed)，充滿在地人文或節令氛圍。"
}`;
