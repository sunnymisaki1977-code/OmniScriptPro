...
如果判斷為【第一類：神佛/歷史人物】，請輸出：
{
  ...
  "poem": "一句符合主題祝福詩詞（由上到下由右到左不要標點符號）",
  "tags": ["標籤1", "標籤2", "標籤3"],
  "imagePrompt": "「${name}」以視覺描述特徵形象,壯闊河山、山水、名勝古蹟為背景,周圍特效,充滿意境史詩感的氛圍，[一句符合主題祝福詩詞（由上到下由右到左不要標點符號）]
[藝術書法文字：神明聖號（由上到下由右到左不要標點符號）][10-15 字的精煉副標題，需點出其神格或象徵（由上到下由右到左不要標點符號）]。"
}
...
如果判斷為【第二類：節氣】，請輸出：
{
  ...
  "poem": "一句符合主題的祝福詩詞（由上到下，由右到左不要標點符號）",
  "tags": ["標籤1", "標籤2", "標籤3"],
  "imagePrompt": "請針對此節氣生成『純無人風景與靜物微距特寫』的視覺描述，[藝術書法文字：節氣名稱（由上到下，由右到左不要標點符號）][一句符合主題祝福詩詞（由上到下由右到左不要標點符號）][10-15 字的精煉副標題，點出節令意涵（由上到下，由右到左不要標點符號）]。強烈要求：畫面絕對禁止出現任何人物、人類輪廓、剪影或人造物。請將畫面視覺焦點 100% 集中於『特定植物、天候光影變化、自然地貌或空景』，並可加上 --no humans, people, person 參數。"
}`;
    });
