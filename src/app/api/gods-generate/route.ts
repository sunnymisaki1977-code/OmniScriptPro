...
[神明聖號（由上到下由右到左不要標點符號）][10-15 字的精煉副標題，需點出其神格或象徵（由上到下由右到左不要標點符號）]。"
}
...
如果判斷為【第二類：節氣】，請輸出：
{
  ...
  "tags": ["標籤1", "標籤2", "標籤3"],
  "imagePrompt": "請針對此節氣生成『純無人風景與靜物微距特寫』的視覺描述。強烈要求：畫面絕對禁止出現任何人物、人類輪廓、剪影或人造物。請將畫面視覺焦點 100% 集中於『特定植物、天候光影變化、自然地貌或空景』，並可加上 --no humans, people, person 參數。"
}`;
    });
